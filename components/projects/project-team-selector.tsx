    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <label className="text-xs font-bold text-slate-700 flex items-center gap-1.5 font-display">
          ...
          <span>Assign UXI Engineers ({selectedIds.length} selected)</span>
        </label>
        <span className="text-[11px] text-slate-500 font-medium">Workload & availability aware</span>
      </div>
        ...
        {teamMembers.map((member) => {
          ...
          return (
            <button
              ...
              className={cn(
                "flex items-center gap-3 p-3 rounded-xl border text-left transition-all duration-150 group shadow-sm",
                isSelected
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                {/* Workload & Availability Telemetry */}
